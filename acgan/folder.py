...
def make_dataset(dir, class_to_idx, image_to_age, image_to_gender):
    images = []
...
class ImageFolder(data.Dataset):
    ...
    def __init__(self, image_to_age, image_to_gender, root, transform=None, target_transform=None,
                 loader=default_loader, classes_idx=None):
        self.classes_idx = classes_idx
        classes, class_to_idx = find_classes(root, self.classes_idx)
        imgs = make_dataset(root, class_to_idx, image_to_age, image_to_gender)
        if len(imgs) == 0:
